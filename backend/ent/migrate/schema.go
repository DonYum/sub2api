...
var (
	...
	UsageLogsColumns = []*schema.Column{
		...
		{Name: "client_machine_id", Type: field.TypeString, Nullable: true, Size: 255},
		{Name: "client_machine_source", Type: field.TypeString, Nullable: true, Size: 32},
		{Name: "client_device_id", Type: field.TypeString, Nullable: true, Size: 255},
		{Name: "client_account_uuid", Type: field.TypeString, Nullable: true, Size: 128},
		{Name: "client_originator", Type: field.TypeString, Nullable: true, Size: 255},
		{Name: "codex_installation_id", Type: field.TypeString, Nullable: true, Size: 255},
		{Name: "codex_window_id", Type: field.TypeString, Nullable: true, Size: 255},
		{Name: "codex_session_id", Type: field.TypeString, Nullable: true, Size: 255},
		{Name: "codex_thread_id", Type: field.TypeString, Nullable: true, Size: 255},
		{Name: "codex_turn_id", Type: field.TypeString, Nullable: true, Size: 255},
		{Name: "terminal_hash", Type: field.TypeString, Nullable: true, Size: 64},
		{Name: "image_count", Type: field.TypeInt, Default: 0},
	...
	UsageLogsTable = &schema.Table{
		...
		Indexes: []*schema.Index{
			...
			},
			{
				...
				Unique:  false,
				Columns: []*schema.Column{UsageLogsColumns[58], UsageLogsColumns[54]},
			},
			{
				Name:    "usagelog_api_key_id_created_at",
				Unique:  false,
				Columns: []*schema.Column{UsageLogsColumns[55], UsageLogsColumns[54]},
			},
			{
				Name:    "usagelog_group_id_created_at",
				Unique:  false,
				Columns: []*schema.Column{UsageLogsColumns[57], UsageLogsColumns[54]},
			},
		},
	}
