...
type APIKey struct {
	...
	// Capture raw gateway request/response bodies for this key
	RawMessageRecordingEnabled bool `json:"raw_message_recording_enabled,omitempty"`
...
func (*APIKey) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case apikey.FieldIPWhitelist, apikey.FieldIPBlacklist:
			values[i] = new([]byte)
		case apikey.FieldRawMessageRecordingEnabled:
	...
	for i := range columns {
		...
		case apikey.FieldRawMessageRecordingEnabled:
			if value, ok := values[i].(*sql.NullBool); !ok {
				return fmt.Errorf("unexpected type %T for field raw_message_recording_enabled", values[i])
			} else if value.Valid {
				_m.RawMessageRecordingEnabled = value.Bool
			}
...
func (_m *APIKey) String() string {
	...
	builder.WriteString(", ")
	builder.WriteString("raw_message_recording_enabled=")
	builder.WriteString(fmt.Sprintf("%v", _m.RawMessageRecordingEnabled))
	builder.WriteString(", ")
