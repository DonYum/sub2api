...
const (
	...
	FieldStatus = "status"
	// FieldRawMessageRecordingEnabled holds the string denoting the raw_message_recording_enabled field in the database.
	FieldRawMessageRecordingEnabled = "raw_message_recording_enabled"
...
var Columns = []string{
	...
	FieldGroupID,
	FieldStatus,
	FieldRawMessageRecordingEnabled,
	FieldLastUsedAt,
	FieldIPWhitelist,
	FieldIPBlacklist,
	FieldQuota,
...
var (
	...
	// DefaultRawMessageRecordingEnabled holds the default value on creation for the "raw_message_recording_enabled" field.
	DefaultRawMessageRecordingEnabled bool
...
// ByRawMessageRecordingEnabled orders the results by the raw_message_recording_enabled field.
func ByRawMessageRecordingEnabled(opts ...sql.OrderTermOption) OrderOption {
	return sql.OrderByField(FieldRawMessageRecordingEnabled, opts...).ToFunc()
}
