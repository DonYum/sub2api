...
func init() {
	...
	// apikeyDescRawMessageRecordingEnabled is the schema descriptor for raw_message_recording_enabled field.
	apikeyDescRawMessageRecordingEnabled := apikeyFields[5].Descriptor()
	// apikey.DefaultRawMessageRecordingEnabled holds the default value on creation for the raw_message_recording_enabled field.
	apikey.DefaultRawMessageRecordingEnabled = apikeyDescRawMessageRecordingEnabled.Default.(bool)
