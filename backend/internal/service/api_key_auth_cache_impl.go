...
const apiKeyAuthSnapshotVersion = 18 // v18: include per-key raw message recording gate
...
func (s *APIKeyService) snapshotFromAPIKey(ctx context.Context, apiKey *APIKey) *APIKeyAuthSnapshot {
	...
	snapshot := &APIKeyAuthSnapshot{
		...
		RawMessageRecordingEnabled: apiKey.RawMessageRecordingEnabled,
...
func (s *APIKeyService) snapshotToAPIKey(key string, snapshot *APIKeyAuthSnapshot) *APIKey {
	...
	apiKey := &APIKey{
		...
		RawMessageRecordingEnabled: snapshot.RawMessageRecordingEnabled,
