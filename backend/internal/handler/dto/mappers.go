...
func usageLogFromServiceUser(l *service.UsageLog) UsageLog {
	...
	return UsageLog{
		...
		ClientMachineID:           l.ClientMachineID,
		ClientMachineSource:       l.ClientMachineSource,
		ClientDeviceID:            l.ClientDeviceID,
		ClientAccountUUID:         l.ClientAccountUUID,
		ClientOriginator:          l.ClientOriginator,
		CodexInstallationID:       l.CodexInstallationID,
		CodexWindowID:             l.CodexWindowID,
		CodexSessionID:            l.CodexSessionID,
		CodexThreadID:             l.CodexThreadID,
		CodexTurnID:               l.CodexTurnID,
		TerminalHash:              l.TerminalHash,
