...
const exportToExcel = async () => {
  ...
  try {
    ...
    const headers = [
      ...
      t('usage.kiroCredits'), t('usage.kiroInputTokens'), t('usage.kiroOutputTokens'),
    ...
    while (true) {
      ...
      const rows = (res.items || []).map((log: AdminUsageLog) => [
        ...
        log.upstream_kiro_credits ?? '', log.upstream_kiro_input_tokens ?? '', log.upstream_kiro_output_tokens ?? '',
