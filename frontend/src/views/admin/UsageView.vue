...
const breakdownFilters = computed(() => {
  ...
  if (filters.value.reasoning_effort) f.reasoning_effort = filters.value.reasoning_effort
  return f
})
...
const filters = ref<AdminUsageQueryParams>({ user_id: undefined, model: undefined, group_id: undefined, request_type: undefined, billing_type: null, reasoning_effort: undefined, start_date: startDate.value, end_date: endDate.value })
...
const resetFilters = () => {
  ...
  filters.value = { start_date: startDate.value, end_date: endDate.value, request_type: undefined, billing_type: null, billing_mode: undefined, reasoning_effort: undefined }
  granularity.value = getGranularityForRange(startDate.value, endDate.value)
  applyFilters()
}
