...
const openaiModels = [
  // GPT-6 系列
  'gpt-6', 'gpt-6-luna', 'gpt-6-sol', 'gpt-6-terra',
  // GPT-5.2 系列
...
const openaiPresetMappings = [
  ...
  { label: 'GPT-6', from: 'gpt-6', to: 'gpt-6', color: 'bg-orange-100 text-orange-700 hover:bg-orange-200 dark:bg-orange-900/30 dark:text-orange-400' },
