export default {
  ...
  usage: {
    ...
    kiroListPriceCostEstimate: 'Kiro list price estimate',
    kiroSavingsCostEstimate: 'Kiro savings estimate',
    kiroDiscountRateEstimate: 'Kiro discount rate estimate',
    kiroSavingsShort: 'Save',
    kiroInputTokens: 'Kiro input tokens',
    kiroOutputTokens: 'Kiro output tokens',
    kiroInputOutputTokens: 'Kiro input/output',
    totalRequests: 'Total Requests',
    totalTokens: 'Total Tokens',
    totalCost: 'Total Cost',
