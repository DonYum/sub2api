export default {
  ...
  usage: {
    ...
    kiroListPriceCostEstimate: 'Kiro 原价估算',
    kiroSavingsCostEstimate: 'Kiro 节省估算',
    kiroDiscountRateEstimate: 'Kiro 折扣率估算',
    kiroSavingsShort: '省',
    kiroInputTokens: 'Kiro 输入 Token',
    kiroOutputTokens: 'Kiro 输出 Token',
    kiroInputOutputTokens: 'Kiro 输入/输出',
    totalRequests: '总请求数',
    totalTokens: '总 Token',
    totalCost: '总消费',
    standardCost: '标准',
