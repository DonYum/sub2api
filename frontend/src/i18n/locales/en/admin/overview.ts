export default {
    ...
    users: {
      ...
      rawMessageRecording: 'Raw recording',
      rawMessageRecordingUpdated: 'Raw message recording updated',
      rawMessageRecordingFailed: 'Failed to update raw message recording',
